    ...
    inputPanel(
      ...
      selectInput("var", 
                  ...
                  choices = list(" " = toString(which(statesData$placeHolderColumn)), 
                                 ...
                                 "Service Providers need to notify customers" = c("as soon as possible" = toString(which(statesData$asSoonAsPossible)),
...
"immediately after discovery in all cases" = toString(which(statesData$immediatelyAfterDiscovery)),
