...
Furthermore it would be good to clarify some things.  When the threshold of consumers affected is 0 for notifying the Attorney General, this indicates that a specific number has not been specified (however the Attorney General may still have to be notified).  

If the threshold to notify the Attorney General is 1, this typically indicates that a person must also provide notice of a breach to the Attorney General, whenever (and no later than the time when) notice is provided to residents.  
