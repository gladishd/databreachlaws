...
sidebarLayout(
  ...
  #sidebarPanel
    inputPanel(
      ...
      selectInput("var", 
                  label = "",
                  choices = c(" " = toString(which(statesData$placeHolderColumn)), "Date of Birth alone is PI" = toString(which(statesData$hasDOBasPI)), "Information about Online Accounts is PI" = toString(which(statesData$hasOnlineAccountsasPI)), 
