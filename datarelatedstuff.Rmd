...
statesData$serviceProvidersNotifyCustomers <- ifelse((str_detect(statesData$serviceProvidersNotifyCustomers, "Immediately") == TRUE), TRUE, statesData$serviceProvidersNotifyCustomers)
